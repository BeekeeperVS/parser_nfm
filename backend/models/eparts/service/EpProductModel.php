 ...
 */
class EpProductModel extends \app\models\eparts\db\EpProductModel
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return \app\models\eparts\query\EpProductModelQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\eparts\query\EpProductModelQuery(get_called_class());
    }
}
