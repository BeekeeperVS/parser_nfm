 ...
 */
class EpProductSeries extends \app\models\eparts\db\EpProductSeries
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(EpProductModel::className(), ['series_id' => 'id']);
    }
    ...
    /**
     * {@inheritdoc}
     * @return \app\models\eparts\query\EpProductSeriesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\eparts\query\EpProductSeriesQuery(get_called_class());
    }
}
