 ...
 */
class EpProductLine extends \app\models\eparts\db\EpProductLine
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return \app\models\eparts\query\EpProductLineQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\eparts\query\EpProductLineQuery(get_called_class());
    }
}
