 ...
 * @property EpProductSeries $line0
...
class EpProductModel extends \app\service\db\ActiveRecordService
{
    ...
    public function rules()
    {
        return [
            ...
            [['line_id'], 'exist', 'skipOnError' => true, 'targetClass' => EpProductSeries::className(), 'targetAttribute' => ['line_id' => 'id']],
    ...
    {
        return $this->hasOne(EpProductSeries::className(), ['id' => 'line_id']);
    }
